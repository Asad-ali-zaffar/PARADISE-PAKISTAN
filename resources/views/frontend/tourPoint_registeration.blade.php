                ...
                <div class="content-side col-xl-9 col-lg-8 col-md-12 col-sm-12">
                    <div class="blog-classic padding-right">
                        <form action="{{$url}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <x-input type="text" name="tour_point_name" label="Tour Point Name:" id="tour_point_name" placeholder="Enter Point Name" value="" pattern="" />
                            ...
                            <x-input type="text" name="tour_point_address" label="Tour Point Address:"
                                id="tour_point_address" placeholder="Enter tour point address" value="" pattern="" />
                                <div class="row">
                                    <div class="form-group col-md-6 required">
                                        <label for="tour_point_history">Tour Point History:</label><br>
                                        <textarea name="tour_point_history" id="tour_point_history" class="border rounded" cols="105" rows="2"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="form-group col-md-6 required">
