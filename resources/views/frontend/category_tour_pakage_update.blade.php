                	...
                	<div class="blog-classic padding-right">
                        <form action="{{$url}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                             ...
                             <x-input type="text" name="pakege_description" label="pakege_description:" id="pakege_description" placeholder="Enter pakege_description" value="{{$pakagecatagorys->pakege_description}}" pattern=""/>
