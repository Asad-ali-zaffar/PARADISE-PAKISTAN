                 ...
                 <div class="content-side col-xl-9 col-lg-8 col-md-12 col-sm-12">
                	<div class="blog-classic padding-right">
                        <form action="{{$url}}" method="post" enctype="multipart/form-data">
                            ...
                            {{-- <x-input type="text" name="city_name" label="City" id="city_name" placeholder="Enter city name" value="" pattern=""/> --}}
                            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <x-input type="text" name="city_history" label="City History:" id="city_history" placeholder="Enter city history" value="" pattern=""/>
