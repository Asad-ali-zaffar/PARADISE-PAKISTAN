                	...
                	<div class="blog-classic padding-right">
                        ...
                        <div class="news-block-three">
		                    <div class="inner-box">
		                        ...
		                        <div class="image-box">
		                            <figure class="image"><img src="{{url('tour_point_img').'/'.$Cityes->tour_point_img}}" alt=""></figure>
		                            <span class="date">9 may 2019</span>
		                        </div>
		                        <div class="lower-content">
		                            <div class="post-meta">
		                            <div class="lower-box">
                                        <h3>History of {{$Cityes->tour_point_name}} <br>Tour Point Address: {{$Cityes->tour_point_address}}</h3>
                                        <div class="text">
                                            <p>{{$Cityes->tour_point_history}} </p>

                                            {{-- @foreach ($TourPoint as $TourPointe ) --}}
                                            <h4> {{--$TourPointe->tour_point_name--}} </h4>
                                            <div class="row clearfix">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <p>{{--$TourPointe->tour_point_address--}}
                                                        <br>
                                                        <b>History of Tour Point:</b>
                                                        {{$Cityes->tour_point_history}}
                        ...
                        @foreach ($City as $TourPointe )
		                <!-- News Block Three 5 Dera Ghazi Khan Division-->
		                <div class="news-block-three">
		                    <div class="inner-box">
		                        <div class="image-box">
		                            <figure class="image"><img src="{{url('visiters').'/'.$TourPointe->city_image}}" alt=""></figure>
		                            <span class="date">9 may 2019</span>
		                        </div>
		                        <div class="lower-content">
		                            <h3><a href="#">{{$TourPointe->city_name}}</a></h3>
		                            <div class="text">{{$TourPointe->city_history}}</div>
