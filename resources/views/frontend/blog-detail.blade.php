        	...
        	<div class="row clearfix">
                ...
                <div class="content-side col-xl-9 col-lg-8 col-md-12 col-sm-12">
                	<div class="blog-single padding-right">
						<div class="inner-box">
							<div class="image-box">
                                <figure class="image"><img src="{{url('frontend/images/resource/news-4.jpg')}}" alt=""></figure>
                        ...
                        <div class="comments-area">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="comment-box">
                                    <div class="comment">
                                        <div class="author-thumb"><img src="{{url('frontend/images/resource/author-1.jpg')}}" alt=""></div>
				...
				<div class="sidebar-side col-xl-3 col-lg-4 col-md-12 col-sm-12">
					<aside class="sidebar">
                        ...
                        <div class="sidebar-widget popular-posts">
                            ...
                            <article class="post">
                            	<figure class="post-thumb"><a href="blog-detail.html"><img src="{{url('frontend/images/resource/post-thumb-1.jpg')}}" alt=""></a></figure>
                            ...
                            <article class="post">
                            	<figure class="post-thumb"><a href="blog-detail.html"><img src="{{url('frontend/images/resource/post-thumb-2.jpg')}}" alt=""></a></figure>
                                <div class="text"><a href="blog-detail.html">Organically grow the holistic world view ...</a></div>
                                <div class="post-info">12 April. 2019</div>
                            </article>

                            <article class="post">
                            	<figure class="post-thumb"><a href="blog-detail.html"><img src="{{url('frontend/images/resource/post-thumb-3.jpg')}}" alt=""></a></figure>
                                <div class="text"><a href="blog-detail.html">Bring to the table in the win-win survival ...</a></div>
                                <div class="post-info">12 April. 2019</div>
                            </article>

                            <article class="post">
                            	<figure class="post-thumb"><a href="blog-detail.html"><img src="{{url('frontend/images/resource/post-thumb-4.jpg')}}" alt=""></a></figure>
